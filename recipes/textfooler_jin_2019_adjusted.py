...
def TextFoolerJin2019Adjusted(
    model, SE_thresh=0.98, word_thres=0.9, sentence_encoder="bert"
):
    """
    ...
    #
    constraints.append(WordEmbeddingDistance(min_cos_sim=word_thres))
    #
    # Universal Sentence Encoder with a minimum angular similarity of ε = 0.98.
    #
